        ...
        <div class="article_insert " >
          ...
          <div class="post">
            <div class=" align-items-center mb-2">
              ...
              <div class="imgate">
                <img :src="`https://localhost:7259/Images/${objArticleDetail.articlePhoto}`" alt="">
              </div>
              <div>
          ...
          <div class="contents_area" ref="commentall" v-for="item in objArticleDetail.messageComment" :key="item.id">
            <div class="comment">
...
export default {
    ...
    methods:{
      ...
      async clickMessage(){
        ...
        await axios.post(`https://localhost:7259/api/Message/CreateComment`,{content})
            .then(response=> {
